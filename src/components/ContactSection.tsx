    ...
    <section id="contacto" className="tech-surface py-16 text-white">
      <div className="section-shell relative z-10 grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="mt-7 grid gap-4">
            ...
            {profile.whatsapp ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex w-fit items-center gap-3 rounded-full border border-cyan-300/25 px-4 py-2 text-sm font-bold text-cyan-100 transition hover:border-cyan-300 hover:text-cyan-300"
              >
            ...
            <div className="flex gap-3 pt-2">
              <a
                ...
                rel="noreferrer"
                aria-label="LinkedIn"
                className="inline-flex size-11 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-cyan-500"
              >
        ...
        <form
          ...
          className="rounded-lg border border-cyan-300/15 bg-[#091315]/90 p-5 text-white shadow-2xl shadow-black/20"
        >
          ...
          <label className="mt-4 block">
            ...
            <textarea
              ...
              minLength={10}
              rows={5}
              className="mt-2 w-full resize-none rounded-lg border border-cyan-300/15 bg-white/5 px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-500 focus:border-cyan-300 focus:ring-4 focus:ring-cyan-300/10"
            />
          </label>
          <button
            type="submit"
            disabled={state === "loading"}
            className="mt-5 inline-flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-cyan-400 px-6 text-sm font-black text-slate-950 transition hover:bg-cyan-300 disabled:cursor-not-allowed disabled:opacity-70"
          >
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="mt-2 h-11 w-full rounded-lg border border-cyan-300/15 bg-white/5 px-4 text-sm text-white outline-none transition focus:border-cyan-300 focus:ring-4 focus:ring-cyan-300/10"
      />
    </label>
  );
}
